...
`release.yml` verifies the version, runs the same gates as CI, builds
Linux x86_64 / Windows x86_64 / macOS Apple Silicon binaries, and publishes
them on a GitHub release with generated notes:
